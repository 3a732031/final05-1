                ...
                <div class="col-lg-8 col-md-10 mx-auto">
                    <form action="/cart/store" method="post">
                        ...
                        <div style="text-align:center">
                            <a class="btn btn-outline-danger mt-auto" href="{{route('product')}}">取消</a>
                            &emsp;&emsp;<button type="submit" class="btn btn-outline-success mt-auto" name="products_id" value="{{$product->id}}">加入購物車</button>
                        </div>
                    </form>
                </div>
            </div>
